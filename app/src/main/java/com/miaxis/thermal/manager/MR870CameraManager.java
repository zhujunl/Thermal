...
public class MR870CameraManager {

    private MR870CameraManager() {
    }

    public static MR870CameraManager getInstance () {
        return SingletonHolder.instance;
    }

    private static class SingletonHolder {
        private static final MR870CameraManager instance = new MR870CameraManager();
    }
